...
const UserDetails = () => {
  ...
  const handleGetOneUserData = () => {
    const url = `https://mybrokerbackend.onrender.com/api/userdata/${id}`;
    axios
      .get(url)
      .then((res) => {
  ...
  const AddProfit = () => {
    const url = `https://mybrokerbackend.onrender.com/api/add-profit/${id}`;
  ...
  const handleSendEmail = () => {
    setSendEmail(false);
    const toastLoadingId = toast.loading("Please wait...");
    const url = `https://mybrokerbackend.onrender.com/api/adminsendemail/${id}`;
    axios
      .post(url, emaildatas)
      .then((response) => {
        console.log(response);
  ...
  const handleLogin = () => {
    ...
    setTimeout(() => {
      ...
      window.location.href = `https://okxcryptobasedashboard.vercel.app/#/dashboard/${userId}`;
    }, 3000);
    setShowActions(false);
  };
    ...
    <>
          ...
          <div className="w-full h-max flex phone:flex-col phone:gap-5 p-4 phone:p-2 phone:py-4 px-8 border border-gray-200 rounded">
            ...
            <div className="w-1/4 phone:w-full h-28 phone:h-max flex flex-col phone:flex-row justify-between ">
              ...
              <div className="w-full h-[45%]">
                ...
                <p className="text-sm ">${oneUserData?.totalInvestment}.00</p>
              </div>
            </div>
            <div className="w-1/4 phone:w-full h-28 phone:h-max flex flex-col phone:flex-row justify-between ">
              <div className="w-full h-[45%] flex flex-col justify-between">
      ...
      >
        <p className="text-base">
          Are you sure you want to reset password for {oneUserData.userName} to
          user01236
        </p>
      </Modal>
      <Modal
        ...
        <div className="w-full h-max pt-6 flex flex-col gap-4">
          ...
          <div className="w-full h-max">
            <input
              ...
              onChange={(e) =>
                setEmaildatas({ ...emaildatas, subject: e.target.value })
              }
            />
          </div>
          <div className="w-full h-max">
            <textarea
              ...
              onChange={(e) =>
                setEmaildatas({ ...emaildatas, msg: e.target.value })
              }
            ></textarea>
          </div>
        </div>
