...
const ManageWithdrawal = () => {
  ...
  const sendSignUpEmail = async (id) => {
    const urlemail = `https://mybrokerbackend.onrender.com/api/confirmwithdrawalemailsend/${id}`;
    axios
      .post(urlemail)
      .then((response) => {
  ...
  const acceptDeposit = (withdrawId) => {
    const url = `https://mybrokerbackend.onrender.com/api/confirm-withdrawal/${withdrawId}`;
    axios
      .post(url)
      .then((response) => {
  ...
  const getallDeposit = () => {
    const url = "https://mybrokerbackend.onrender.com/api/allwithdrawal";
    axios
      .get(url)
      .then((response) => {
              ...
              >
                ...
                <div className="w-36 h-max flex items-center gap-2">
                  <button
                    ...
                    onClick={() => acceptDeposit(props._id)}
                  >
                    Accept
                  </button>
